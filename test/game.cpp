...
class CfgAmmo
{
    ...
    class BulletCore : DefaultAmmo
    {
        ...
        simulationStep=0.05;
        timeToLive=3;
        soundSpeedAppliesToHit=1;
        explosive=0;
        soundHit1[]={"", 0.031622775, 1};
        soundHit2[]={"", 0.031622775, 1};
        soundHit3[]={"", 0.031622775, 1};
        soundHitMan1[]={"", 0.0125892535, 1};
        soundHitMan2[]={"", 0.0125892535, 1};
...
class CfgVehicles
{
    ...
    class Transport : All
    {
        displayName="$STR_DN_TRANSPORT";
        nameSound="veh_transport";
...
{
    defaultVisibility=10000;
    defaultTerrainGrid="12.5f";
    defaultObjectViewDistance=3200;
...
class CfgInGameUI
{
    ...
    class TankDirection
    {
        ...
        height=0.26;
        color[]={0.8, 0.8, 0.8, 1};
        colorHalfDammage[]={0.8, 0.6, 0, 1};
        colorFullDammage[]={0.7, 0.1, 0, 1};
    ...
    class Bar
    {
        ...
        colorGreen[]={0, 0.6, 0, 1};
        colorYellow[]={0.8, 0.6, 0, 1};
        colorRed[]={0.7, 0.1, 0, 0.9};
        colorBlinkOn[]={1, 0.2, 0.2, 1};
        colorBlinkOff[]={0.7, 0.1, 0, 0.9};
        height=0.01;
        shadow=0;
    };
    class ProgressFont
    ...
    class Cursor
    {
        ...
        missionFade=0.3;
        missionColor1[]={0.8, 0.6, 0, 0.5};
        missionColor2[]={0.8, 0.6, 0, 1};
        customMark="#(argb,8,8,3)color(1,0.53,0.12,1)";
        customMarkColor[]={0.8, 0.8, 0.8, 1};
        blinkingPeriod=2;
        freeLookActionColor[]={0.7, 0.1, 0, 1};
        freeLookActionColorSelected[]={0, 0.6, 0, 1};
        freeLookActionColorAvailable[]={0.1, 0.1, 0.9, 1};
        shadow=0;
        infoTextShadow=0;
        font="TahomaB";
        size="( 16 / 408 )";
...
class CfgEnvSounds
{
    ...
    {
        name="";
        sound[]={"", 5.6234123E-05, 1};
        volume="meadow*(1-rain)*(1-night)";
    };
    class Trees
    {
        name="";
        sound[]={"", 0.00017782791, 1};
    ...
    class CaveSmall
    {
        name="";
        sound[]={"", 0.00017782791, 1};
        volume="caveSmall*(1-rain)*(1-windy)*(1-night)";
    };
    class CaveBig
    {
        name="";
        sound[]={"", 5.6234123E-05, 1};
        volume="caveBig*(1-windy)";
    };
};
